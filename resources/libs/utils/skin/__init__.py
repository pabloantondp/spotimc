...
#    xbmc.log(msg='skinutil.check_skin_writability Hemos pasado make copy', level=xbmc.LOGNOTICE)
...
def check_needs_restart():
    '''Check if the skin was copied to the user folder but XBMC was not
    restarted yet'''
